...
SELECT  
    ...
    COUNT(DISTINCT trip_id) FILTER (
        WHERE ftr.expected_departure <= NOW() - INTERVAL '1 hour'
          AND ftr.expected_arrival >= NOW() - INTERVAL '1 hour'
...
-- 	    ftr.departure_time_trip,
--     	ftr.arrival_time_trip,
--     	ftr.status_trip
-- FROM dwh.f_trips_realtime ftr
...
-- GROUP BY trip_id, dso.station_name,dsd.station_name,ftr.departure_time_trip, ftr.arrival_time_trip, ftr.status_trip
-- ORDER BY ftr.departure_time_trip ASC
